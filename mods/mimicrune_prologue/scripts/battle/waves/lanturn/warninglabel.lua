    ...
    self.timer:script(function(wait)
        ...
        bullet.destroy_on_hit = false
            ...
            linefunction(bullet.x,bullet.y)
                self.timer:tween(2.5, bullet, {x=-260}, "in-back", function()
                self.timer:tween(1, bullet, {x=original_x})
            end)
                self.timer:tween(2.5, enemy, {x=-260}, "in-back", function()
            ...
            self.timer:tween(1, enemy, {y=soul.y + 40})
                self.timer:tween(2, bullet, {x=-260}, "in-back", function()
                self.timer:tween(1, bullet, {x=original_x})
            end)
                self.timer:tween(2, enemy, {x=-260}, "in-back", function()
                self.timer:tween(1, enemy, {x=original_x})
            end)
            wait(3)
            enemy:alert()
            ...
            linefunction(bullet.x,bullet.y)
                self.timer:tween(1, enemy, {y=soul.y + 40})
                self.timer:tween(1, bullet, {x=-260}, "in-back", function()
                self.timer:tween(1, bullet, {x=original_x})
            end)
                self.timer:tween(1, enemy, {x=-260}, "in-back", function()
                self.timer:tween(1, enemy, {x=original_x})
            end)
            wait(2)
            enemy:alert()
            ...
            linefunction(bullet.x,bullet.y)
                self.timer:tween(1, enemy, {y=soul.y + 40})
                self.timer:tween(0.7, bullet, {x=-260}, "in-back", function()
                self.timer:tween(0.2, bullet, {x=original_x})
            end)
                self.timer:tween(0.7, enemy, {x=-260}, "in-back", function()
                self.timer:tween(0.2, enemy, {x=original_x})
            end)
            wait(1.2)
            enemy:alert()
            Assets.playSound("defeatrun")
