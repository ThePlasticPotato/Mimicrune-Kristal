...
function Map:init(world, data)
    ...
    self.underwater_underlay_opacity = 0.68
    self.underwater_underlay_void_strength = 1
    self.underwater_underlay_speed = 1
    self.underwater_underlay_pixel_size = 2
    self.underwater_underlay_scale = 1
    self.underwater_underlay_distortion = 6
    self.underwater_underlay_particle_strength = 0.35
    ...
    self.terrain_edge_fog_extent = 60
    self.terrain_edge_fog_opacity = 0.25
