...
function TaintedFountainBase:init(data, battlemode)
    ...
    self.wing_left = Sprite("world/nowhere/wings/left", data.x - 200, battlemode and 80 or (data.y + self.height/4))
    ...
    self.wing_right = Sprite("world/nowhere/wings/right", data.x + 100, battlemode and 80 or (data.y + self.height/4))
