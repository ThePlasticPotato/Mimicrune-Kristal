...
## [1.92.0-1] (2025-07-01)
### Changed
- Updated to Dear ImGui 1.92.0 (docking branch)
- Added `imgui.love.Focus`
### Breaking changes
- Removed support for `Alpha8` texture format
- Removed `imgui.love.BuildFontAtlas` as textures are now dynamically created
- LÖVE textures cannot be passed directly to Dear ImGui functions, they must be converted first using `imgui.love.TextureRef`

## [1.91.8-1] (2025-02-04)
### Changed
- Updated to Dear ImGui 1.91.8 (docking branch)

## [1.91.4-1] (2024-11-02)
### Changed
- Updated to Dear ImGui 1.91.4 (docking branch)
...
### Changed
- Updated to Dear ImGui 1.91.2 (docking branch)
- Improved performance by storing mesh indices in ByteData instead of a Lua table
...
[Unreleased]: https://codeberg.org/apicici/cimgui-love/compare/1.92.0-1...HEAD
[1.92.0-1]: https://codeberg.org/apicici/cimgui-love/compare/1.91.8-1...1.92.0-1
[1.91.8-1]: https://codeberg.org/apicici/cimgui-love/compare/1.91.4-1...1.91.8-1
[1.91.4-1]: https://codeberg.org/apicici/cimgui-love/compare/1.91.2-1...1.91.4-1
[1.91.2-1]: https://codeberg.org/apicici/cimgui-love/compare/1.91.1-1...1.91.2-1
