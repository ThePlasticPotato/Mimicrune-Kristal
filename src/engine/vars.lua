...
KRISTAL_EVENT = {
    ...
    onRegisterNights = "onRegisterNights",
    onRegisterAnimatronics = "onRegisterAnimatronics",
    onRegisterOffices = "onRegisterOffices",
    onRegisterShiftCameras = "onRegisterShiftCameras",
